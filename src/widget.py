...
def mask_account_card(card_or_account: str) -> str:
    ...
    nuber_card = []
    name_card = []
    card_or_account_list = card_or_account_str.split()
    print(len(card_or_account_list))
    print(card_or_account_list)
    ...
    if "Счет" in card_or_account_list:
    ...
    elif ("MasterCard" in card_or_account_list or "Maestro" in card_or_account_list or "МИР" in card_or_account_list or
          "Discover" in card_or_account_list or "Mastercard" in card_or_account_list) :
        return f"{card_or_account_list[0]} {get_mask_card_number(card_or_account_list[1])}"
    elif "Visa" in card_or_account_list or "American" in card_or_account_list:
        ...
        while len(name_card) < 2:
            return f"{name_card[0]} {get_mask_card_number(str_numbers_card)}"
